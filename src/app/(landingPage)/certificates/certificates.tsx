...
export interface AppContextType {
  ...
  setDataCertificatesContext: React.Dispatch<
...
const Certificates = () => {
  const [dataCertificatesContext, setDataCertificatesContext] =
    useState<CertificateType[]>(dataCertificates)
  ...
  return (
    <AppContext.Provider
      value={{
        dataCertificatesContext,
        setDataCertificatesContext,
        filterContext,
        setFilterContext,
      }}
    >
